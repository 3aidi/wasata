...
public class Book {
   ...
   public int getBookId()               { return this.bookId.get(); }
   public IntegerProperty bookIdProperty() { return this.bookId; }
   ...
   public boolean isAvailable()               { return this.available.get(); }
   public BooleanProperty availableProperty() { return this.available; }
